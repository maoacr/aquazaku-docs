...
| [0009](/decisiones/0009-donde-corre-aquazaku/) | Cada pieza en su plataforma, con deploy en cada push | Puesta en producción, después de M9 |
| [0010](/decisiones/0010-preview-environment/) | Preview environments sin pagar Supabase Pro: un proyecto, dos schemas separados por `search_path` | Puesta en producción, después del primer deploy |
| [0011](/decisiones/0011-separacion-de-arranques/) | Producción arranca sola; staging sincroniza su schema; migrar es deliberado. El migrador lee `AQUAZAKU_ENV` igual que la app | Cierre de T9 del SDD de preview environments, 9-sep-2026 |
